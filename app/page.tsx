      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-8">
          <div className="lg:col-span-1">
            <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg p-6 border border-indigo-100">
              <ProfileSection />
            </div>
          </div>
          
          <div className="lg:col-span-2">
            <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg p-6 mb-8 border border-indigo-100">
              <AcademicsSection />
            </div>
